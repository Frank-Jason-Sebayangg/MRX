...
FRANK JASON SEBAYANG

\033[92;1m----------------------------------------------------------
\033[97;1m╔[ \033[92;1mCreator  \033[97;1m: \033[93;1mFRAN JASON. \033[97;1mAnd [\033[92;1mQueen's -JASON\033[97;1m]
\033[97;1m╠[ \033[92;1mWhatsApp \033[97;1m: \033[93;1m+6281363076900
\033[97;1m╠[ \033[92;1mFacebook \033[97;1m: \033[93;1mhttps://www.facebook.com/frans.jason.sebayang \033[97;1m[\033[92;1mFollow Me Facebook\033[97;1m]
\033[92;1m----------------------------------------------------------
""")
...
def menu():
	...
	if sayangku=="1" or sayangku=="01":
		...
		jalan(balmond+l+" By FRAN JASON SEBAYANG")
		time.sleep(0.5)
		exit()
	else:
...
def mode_password():
	...
	if mode=="d" or mode=="D":
		...
		cewe = pwa.split(",")
		if len(cewe)>5:
			jalan("\n"+balmond+m+" Jangan Serakah Dek, Minimal 5 Password Aja")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
